...
A pure Rust implementation of [libopus 1.6.1](https://gitlab.xiph.org/xiph/opus), originally created via c2rust transpilation, now nearly fully safe idiomatic Rust. The codebase is **bit-exact** with the C reference and **nearly unsafe-free** (2 documented `unsafe` blocks remain).
...
└── libopus-sys/         # C reference implementation (libopus 1.6.1)
