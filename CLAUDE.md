...
A pure Rust implementation of [libopus 1.3.1](https://github.com/xiph/opus), originally created via c2rust transpilation, now nearly fully safe idiomatic Rust. The codebase is **bit-exact** with the C reference and **nearly unsafe-free** (2 documented `unsafe` blocks remain).
