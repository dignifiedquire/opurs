...
pub fn silk_stereo_quant_pred(pred_Q13: &mut [i32], ix: &mut [[i8; 3]]) {
    ...
    while n < 2 {
        ...
        's_18: while i < STEREO_QUANT_TAB_SIZE - 1 {
            low_Q13 = unsafe { *silk_stereo_pred_quant_Q13.get_unchecked(i as usize) } as i32;
            step_Q13 = ((unsafe {
                *silk_stereo_pred_quant_Q13.get_unchecked((i + 1) as usize) as i32 - low_Q13
            } as i64
            ...
            while j < STEREO_QUANT_SUB_STEPS {
                ...
                err_Q13 = if (unsafe { *pred_Q13.get_unchecked(n as usize) }) - lvl_Q13 > 0 {
                    (unsafe { *pred_Q13.get_unchecked(n as usize) }) - lvl_Q13
                } else {
                    -((unsafe { *pred_Q13.get_unchecked(n as usize) }) - lvl_Q13)
                };
                ...
                unsafe {
                    (*ix.get_unchecked_mut(n as usize))[0_usize] = i as i8;
                    (*ix.get_unchecked_mut(n as usize))[1_usize] = j as i8;
                }
                j += 1;
            }
            i += 1;
        ...
        unsafe {
            let ix_n = ix.get_unchecked_mut(n as usize);
            ix_n[2_usize] = (ix_n[0_usize] as i32 / 3) as i8;
            ix_n[0_usize] = (ix_n[0_usize] as i32 - ix_n[2_usize] as i32 * 3) as i8;
            *pred_Q13.get_unchecked_mut(n as usize) = quant_pred_Q13;
        }
        n += 1;
    }
