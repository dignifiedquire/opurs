    ...
    while k < 3 {
        ...
        while j < nb_subfr {
            ...
            silk_VQ_WMat_EC_c(
                ...
                &mut gain_Q7,
                std::slice::from_raw_parts(XX_Q17_ptr, LTP_ORDER as usize * LTP_ORDER as usize),
                std::slice::from_raw_parts(xX_Q17_ptr, LTP_ORDER as usize),
                std::slice::from_raw_parts(cbk_ptr_Q7, cbk_size as usize * LTP_ORDER as usize),
                std::slice::from_raw_parts(cbk_gain_ptr_Q7, cbk_size as usize),
                std::slice::from_raw_parts(cl_ptr_Q5, cbk_size as usize),
                subfr_len,
                max_gain_Q7,
                cbk_size,
            );
