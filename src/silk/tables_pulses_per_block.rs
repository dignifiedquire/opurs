...
pub const silk_pulses_per_block_iCDF: [[u8; SILK_MAX_PULSES + 2]; N_RATE_LEVELS] = [
    [
...
pub const silk_pulses_per_block_BITS_Q5: [[u8; SILK_MAX_PULSES + 2]; N_RATE_LEVELS - 1] = [
    [
...
pub const silk_rate_levels_iCDF: [[u8; N_RATE_LEVELS - 1]; 2] = [
    [241, 190, 178, 132, 87, 74, 41, 14, 0],
    [223, 193, 157, 140, 106, 57, 39, 18, 0],
];
pub const silk_rate_levels_BITS_Q5: [[u8; N_RATE_LEVELS - 1]; 2] = [
