...
pub fn silk_vq_wmat_ec_c(params: &SilkVqWmatEcParams<'_>) -> SilkVqWmatEcResult {
    ...
    neg_x_x_q24[0_usize] = -(((params.x_x_q17[0] as u32) << 7) as i32);
    neg_x_x_q24[1_usize] = -(((params.x_x_q17[1] as u32) << 7) as i32);
    neg_x_x_q24[2_usize] = -(((params.x_x_q17[2] as u32) << 7) as i32);
    neg_x_x_q24[3_usize] = -(((params.x_x_q17[3] as u32) << 7) as i32);
    neg_x_x_q24[4_usize] = -(((params.x_x_q17[4] as u32) << 7) as i32);
    ...
    while k < params.l {
        ...
        let penalty: i32 = (((if gain_tmp_q7 - params.max_gain_q7 > 0 {
            ...
            << 11) as i32;
        sum2_q24 = neg_x_x_q24[0_usize] + params.xx_q17[1] * params.cb_q7[cb_row_off + 1] as i32;
        ...
        sum1_q15 = (sum1_q15 as i64
            ...
            as i32;
        sum2_q24 = neg_x_x_q24[1_usize] + params.xx_q17[7] * params.cb_q7[cb_row_off + 2] as i32;
        ...
        sum1_q15 = (sum1_q15 as i64
            ...
            as i32;
        sum2_q24 = neg_x_x_q24[2_usize] + params.xx_q17[13] * params.cb_q7[cb_row_off + 3] as i32;
        ...
        sum1_q15 = (sum1_q15 as i64
            ...
            as i32;
        sum2_q24 = neg_x_x_q24[3_usize] + params.xx_q17[19] * params.cb_q7[cb_row_off + 4] as i32;
        sum2_q24 = ((sum2_q24 as u32) << 1) as i32;
        sum2_q24 += params.xx_q17[18] * params.cb_q7[cb_row_off + 3] as i32;
        sum1_q15 = (sum1_q15 as i64
            + ((sum2_q24 as i64 * params.cb_q7[cb_row_off + 3] as i16 as i64) >> 16))
            as i32;
        sum2_q24 = ((neg_x_x_q24[4_usize] as u32) << 1) as i32;
