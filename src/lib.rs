...
pub use crate::opus::opus_defines::{
    ...
    OPUS_GET_OSCE_BWE_REQUEST, OPUS_GET_PACKET_LOSS_PERC_REQUEST,
    ...
    OPUS_SET_GAIN_REQUEST, OPUS_SET_IGNORE_EXTENSIONS_REQUEST, OPUS_SET_INBAND_FEC_REQUEST,
    OPUS_SET_LSB_DEPTH_REQUEST, OPUS_SET_MAX_BANDWIDTH_REQUEST, OPUS_SET_OSCE_BWE_REQUEST,
...
pub use crate::opus::opus_defines::{
    ...
    OPUS_BANDWIDTH_WIDEBAND, OPUS_BITRATE_MAX, OPUS_FRAMESIZE_100_MS, OPUS_FRAMESIZE_10_MS,
