//! Pure Rust implementation of the Opus audio codec, bit-exact with libopus 1.6.1.
...
pub mod internals {
    // -- Raw OPUS_* C-level constants (for C-parity tests and FFI) --
    pub use crate::opus::opus_defines::{
        OPUS_ALLOC_FAIL, OPUS_BAD_ARG, OPUS_BUFFER_TOO_SMALL, OPUS_INTERNAL_ERROR,
        OPUS_INVALID_PACKET, OPUS_INVALID_STATE, OPUS_OK, OPUS_UNIMPLEMENTED,
    };
    pub use crate::opus::opus_defines::{
        OPUS_APPLICATION_AUDIO, OPUS_APPLICATION_RESTRICTED_CELT,
        OPUS_APPLICATION_RESTRICTED_LOWDELAY, OPUS_APPLICATION_RESTRICTED_SILK,
        OPUS_APPLICATION_VOIP, OPUS_AUTO, OPUS_BANDWIDTH_FULLBAND, OPUS_BANDWIDTH_MEDIUMBAND,
        OPUS_BANDWIDTH_NARROWBAND, OPUS_BANDWIDTH_SUPERWIDEBAND, OPUS_BANDWIDTH_WIDEBAND,
        OPUS_BITRATE_MAX, OPUS_FRAMESIZE_100_MS, OPUS_FRAMESIZE_10_MS, OPUS_FRAMESIZE_120_MS,
        OPUS_FRAMESIZE_20_MS, OPUS_FRAMESIZE_2_5_MS, OPUS_FRAMESIZE_40_MS, OPUS_FRAMESIZE_5_MS,
        OPUS_FRAMESIZE_60_MS, OPUS_FRAMESIZE_80_MS, OPUS_FRAMESIZE_ARG, OPUS_SIGNAL_MUSIC,
        OPUS_SIGNAL_VOICE,
    };
    pub use crate::opus::opus_defines::{
        ...
        OPUS_GET_FORCE_CHANNELS_REQUEST, OPUS_GET_GAIN_REQUEST, OPUS_GET_IGNORE_EXTENSIONS_REQUEST,
        OPUS_GET_INBAND_FEC_REQUEST, OPUS_GET_IN_DTX_REQUEST,
        OPUS_GET_LAST_PACKET_DURATION_REQUEST, OPUS_GET_LOOKAHEAD_REQUEST,
        OPUS_GET_LSB_DEPTH_REQUEST, OPUS_GET_MAX_BANDWIDTH_REQUEST, OPUS_GET_OSCE_BWE_REQUEST,
        OPUS_GET_PACKET_LOSS_PERC_REQUEST, OPUS_GET_PHASE_INVERSION_DISABLED_REQUEST,
        OPUS_GET_PITCH_REQUEST, OPUS_GET_PREDICTION_DISABLED_REQUEST, OPUS_GET_QEXT_REQUEST,
        ...
        OPUS_SET_FORCE_CHANNELS_REQUEST, OPUS_SET_GAIN_REQUEST, OPUS_SET_IGNORE_EXTENSIONS_REQUEST,
        OPUS_SET_INBAND_FEC_REQUEST, OPUS_SET_LSB_DEPTH_REQUEST, OPUS_SET_MAX_BANDWIDTH_REQUEST,
        OPUS_SET_OSCE_BWE_REQUEST, OPUS_SET_PACKET_LOSS_PERC_REQUEST,
