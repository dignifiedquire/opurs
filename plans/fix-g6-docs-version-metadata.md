...
## Findings IDs
Open: `95,134,222,225,226`
Closed in this group: `96,108,131,133,217,223,227,228`
...
- Remaining open in Group 6 are the intentional version-string format divergence (`95`/`222`), source-comment cleanup (`134`), and two build-config parity items (`225`, `226`).
