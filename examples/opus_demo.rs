...
use opurs::tools::demo::{
    ...
    CommonOptions, Complexity, DecodeArgs, EncodeArgs, EncoderOptions, FrameSize, OpusBackend,
    SampleRate, MAX_PACKET,
};
...
impl DecodeCliArgs {
    fn to_decode_args(self) -> DecodeArgs {
        assert!(self.loss <= 100, "loss must be between 0 and 100");
